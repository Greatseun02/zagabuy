 ...
 */
export interface MultiBadgeRendererParams<TData = any>
    ...
    const badges: BadgeItem[] = badgeValue.map((badge, index) => {
        ...
        if (typeof badge === "object" && badge !== null) {
            return {
                ...
                backgroundColor:
                    badge[bgColorField as keyof typeof badge] as string | undefined,
            };
        }
    ...
    return (
        <div className="flex items-center gap-1.5 flex-wrap">
            {visibleBadges.map((badge, index) => {
                ...
                if (badgeRenderer) {
                    return <React.Fragment key={index}>{badgeRenderer(badge, index)}</React.Fragment>;
                }
