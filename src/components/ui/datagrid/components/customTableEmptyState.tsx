...
import PaddedWarningIcon from "@/components/icon/paddedWarningIcon";
...
function CustomTableEmptyState({
    ...
    if (props?.error) {
        return (
            <div {...props}
                 className={cn("flex flex-col items-center justify-center p-12 gap-4 text-center", props?.className)}>
                <IconWrapper
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Typography weight="regular" size="sm" color="secondary" className="max-w-md">
                        We had some trouble loading this page. Please refresh to try again or contact support if the
                        problem persists.
                        {props.error.message && (
                ...
                {showActions && (
                    <div className="flex items-center gap-3">
                        <BaseButton text="Refresh" startIcon={<RefreshCw className="w-4 h-4"/>}
