...
const EnhancedLabel: React.FC<EnhancedLabelProps> = ({
  ...
  const shouldShowBoth =
    showBothIcons && shouldShowDefaultIcon && shouldShowCustomIcon;
  ...
  if (shouldShowDefaultIcon && defaultIconPosition === "start") {
    startElements.push(
      <React.Fragment key="default">{renderDefaultIcon()}</React.Fragment>,
    );
  }
  ...
  if (
    ...
    iconPosition === "start" &&
    (shouldShowBoth || !shouldShowDefaultIcon)
  ) {
    startElements.push(
      <React.Fragment key="custom">{renderCustomIcon()}</React.Fragment>,
    );
  }
  if (
    shouldShowCustomIcon &&
