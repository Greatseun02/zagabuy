...
export default function AuthLayout({
  ...
  return (
    <div className="grid grid-rows-[auto_1fr] h-dvh relative ">
      <div className="py-5 flex padding customContainer">
        {showLogo && (
          <Link href={RouteConstant.app.path}>
            <ZagabuyLogo showText={true} />
          </Link>
        )}
        <ThemeSwitcher className="ml-auto" />
      </div>

      <div className="flex padding customContainer">
